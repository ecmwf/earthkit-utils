...
def test_warning_block_indentation(msg):
    ...
    for line in lines[1:]:
        if line.strip():
            assert line.startswith("   "), f"Unindented line would break directive: {line!r}"


def test_env_var_default_warns():
    @experimental
    def func():
        return 1
...
def test_warn_once_same_call_site():
    @experimental
    def func():
        return 1
...
def test_warn_twice_two_call_sites():
...
def test_warn_filter_by_message():
    @experimental
    def func():
        return 1
