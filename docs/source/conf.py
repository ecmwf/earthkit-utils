...
extlinks = {
    "pr": ("https://github.com/ecmwf/earthkit-utils/pull/%s", "PR #%s"),
    "issue": ("https://github.com/ecmwf/earthkit-utils/issues/%s", "Issue #%s"),
}
...
# Modules to hide from autodocs (relative to earthkit.utils)
...
html_theme_options = {
    ...
    "light_logo": "earthkit-utils-dark.svg",
    "dark_logo": "earthkit-utils-dark.svg",
    "source_repository": "https://github.com/ecmwf/earthkit-utils/",
